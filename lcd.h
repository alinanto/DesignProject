...
#define LCD_DATA0_PIN    4            /**< pin for 4bit data bit 6  */
#endif
#ifndef LCD_DATA1_PIN
#define LCD_DATA1_PIN    3            /**< pin for 4bit data bit 5  */
#endif
#ifndef LCD_DATA2_PIN
#define LCD_DATA2_PIN    2            /**< pin for 4bit data bit 4  */
#endif
...
//// returns the 'dig' digit position counting from the left of the decimal point,if dig>0
//// returns the '-dig' digit position counting from the right of the decimal point,if dig<0,dig>-4
//// digit(34.21,1);/////returns 4////////////////////
//// digit(34.21,-1);/////returns 2////////////////////
